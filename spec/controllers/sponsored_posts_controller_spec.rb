...
RSpec.describe SponsoredPostsController, type: :controller do
   ...
   let(:my_post) { my_topic.sponsored_posts.create!(title: RandomData.random_sentence, body: RandomData.random_paragraph) }
    ...
    describe "GET show" do
     ...
     it "assigns my_post to @sponsored_posts" do
      get :show, topic_id: my_topic.id, id: my_post.id
   ...
   describe "POST create" do
     ...
     it "assigns Post.last to @sponsored_posts" do
   ...
   describe "PUT update" do
     it "updates post with expected attributes" do
       ...
       put :update, topic_id: my_topic.id, id: my_post.id, sponsored_post: {title: new_title, body: new_body}
